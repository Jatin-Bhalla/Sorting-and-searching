...
algorthm=["LINEAR","BINARY","QUICK","BUBBLE","SELECT"]

linear_button = Radiobutton(window,text = "LINEAR",value=1, variable=x,  command=linear_search , font="comicsansms 8 ",bg ="#F2E9EB",fg="#647295" ) 
#probably add fg and bg colour and active foreground and active background
linear_button.grid(row=8, column=2)
binary_button = Radiobutton(window, text = "BINARY", value=2,  variable=x, command= binary_search, font="comicsansms 8" ,bg ="#F2E9EB",fg="#647295") 
#probably add fg and bg colour and active foreground and active background
binary_button.grid(row=9, column=2)

quick_button = Radiobutton(window, text = "QUICK",value=3,  variable=x,   command=bubble_sort , font="comicsansms 8 ",bg ="#F2E9EB",fg="#647295", ) 
quick_button.grid(row=8, column=6)

bubble_button = Radiobutton(window, text = "BUBBLE",value=4,  variable=x,   command=quick_sort , font="comicsansms 8 " ,bg ="#F2E9EB",fg="#647295") 
#probably add fg and bg colour and active foreground and active background
bubble_button.grid(row=9, column=6)

select_button = Radiobutton(window, text = "SELECT",value=5,   variable=x,  command=selection_sort, font="comicsansms 8 " ,bg ="#F2E9EB",fg="#647295") 
#probably add fg and bg colour and active foreground and active background
